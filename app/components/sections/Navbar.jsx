...
function NavBar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setSticky(document.body.scrollTop > 50);
    };
  ...
  return (
    ...
    <div id="nav" className={sticky ? "sticky top-0 z-50" : ""}>
      <header className={
        cn("flex justify-between md:max-xl:mx-16 xl:w-[75%] mx-auto md:mt-10 px-9 py-5 items-center relative rounded-lg", {
          "bg-[#824d9a]": !sticky,
          "bg-opacity-10": !sticky,
          "bg-[#090118]": sticky,
          "bg-opacity-100": sticky,
          "shadow-md": sticky,
        })
      }>
        {/* Logo */}
